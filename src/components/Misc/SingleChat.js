...
const ENDPOINT = "https://chatmingle-backend.onrender.com";
...
const SingleChat = ({ fetchAgain, setFetchAgain }) => {
  ...
  const fetchMessage = async () => {
    ...
    try {
      ...
      const { data } = await axios.get(
        `https://chatmingle-backend.onrender.com/api/v1/message/${selectedChat._id}`,
        config
      );
      setMessages(data);
  ...
  const sendMessageHandler = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "https://chatmingle-backend.onrender.com/api/v1/message/send",
        {
          content: newMessage,
          chatId: selectedChat,
        },
  ...
  const handleChange = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "https://chatmingle-backend.onrender.com/api/v1/message/send-attachments",
        formData,
        config
      );
